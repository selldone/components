...
import SProductSectionService from "@components/product/section/service/SProductSectionService.vue";
import SProductSectionVariants from "@components/product/section/variants/SProductSectionVariants.vue";
import SProductSectionBadges from "@components/product/section/badges/SProductSectionBadges.vue";
import SProductSectionPrice from "@components/product/section/price/SProductSectionPrice.vue";
import SProductSectionWaitingAuction from "@components/product/section/auction/SProductSectionWaitingAuction.vue";
import SProductSectionBuyButton from "@components/product/section/buy-button/SProductSectionBuyButton.vue";
import SProductSectionExtraButtons from "@components/product/section/extra-buttons/SProductSectionExtraButtons.vue";
...
import SProductSectionExtraPricings from "@components/product/section/extra-pricing/SProductSectionExtraPricings.vue";
import SProductSectionTax from "@components/product/section/tax/SProductSectionTax.vue";
