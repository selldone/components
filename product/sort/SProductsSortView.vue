        ...
        <template v-slot:append>
          <v-tooltip bottom color="#000">
            ...
            <div class="text-start pa-3">
              ...
              <ul class="mt-3">
                <li>
                  <b>Normal : </b>Search Title, MPN, SKU, Brand, Tags
                </li>
                <li>
                  <b>P+Product ID : </b>Find exact product ID, ex. <b class="green--text">P</b><i class="yellow--text">360</i>
                </li>
                <li>
                  <b>Quotes : </b> Use quotes to search for an exact phrase, ex. <b class="green--text">"</b><i
                    class="yellow--text">text here</i><b class="green--text">"</b>
                </li>
                <li>
                  <b>Tax : </b> To find products with a tax profile, ex. <b class="green--text">tax:</b><i
                    class="yellow--text">tax profile name</i>
                </li>
                <li>
                  <b>New Products : </b> To find added products between dates, ex. <b class="green--text">new~</b><i
                    class="yellow--text">2023-08-10</i><b class="green--text">~</b><i
                    class="yellow--text">2023-08-20</i>
                </li>
              </ul>
            </div>
          </v-tooltip>
