...
import { BackofficeMixin } from "@app-backoffice/mixins/BackofficeMixinAuth";
  ...
  methods: {
    ...
    initialState() {
      ...
      if (!this.$vuetify.display.smAndDown && !this.LOGIN_POPUP_LOGIN) {
        this.$emit("set:bg", {
          backgroundImage: `url('${require("@components/backoffice/auth/form/assets/login-page-bg.jpg")}'),url('${require("@components/backoffice/auth/form/assets/login-page-bg-pattern.jpg")}')`,
