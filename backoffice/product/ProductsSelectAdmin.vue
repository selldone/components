      ...
      <v-card>
        ...
        <v-card-text>
          ...
          <div class="widget-box mb-5">
            <widget-header title="Vendor" icon="admin_panel_settings">
            </widget-header>
            <v-subheader
          ...
          <div class="widget-box mb-5">
            <widget-header title="Marketplace pricing" icon="price_change">
            </widget-header>
            <v-subheader
