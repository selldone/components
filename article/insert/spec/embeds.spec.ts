describe("Embeds addon", function () {
  ...
  it("removes also contenteditable attr and ovelay on editor's serialize", function () {
    let html =
        '<div class="medium-insert-embeds"><figure class="medium-insert-embed"></figure></div>',
      editor,
      $serialized;
  ...
  it("uses data-embed-code as container html for javascript-based embeds", function () {
    let html =
        '<div class="medium-insert-embeds"><figure class="medium-insert-embed"><div data-embed-code="&amp;lt;blockquote&amp;gt;good-value&amp;lt;/blockquote&amp;gt;">bad-value</div></figure></div>',
      editor,
      $serialized;
