...
(function ($, window, document, undefined) {
  ...
  const ComponentElementName = "code-editor";

  const RootClassName = ".code-editor";
  const ActiveClassNameSelector = ".medium-insert-code-editor-active";
  const ActiveClassName = "medium-insert-code-editor-active";

  /**
   * ――――――――――――――――――――――― Default values ―――――――――――――――――――――――
   */
  const pluginName = "mediumInsert",
    addonName = "CodeEditorAddon", // first char is uppercase
    defaults = {
      label: '<span class="fas fa-laptop-code"></span> Code Viewer',
  ...
  CustomAddon.prototype.deleteAction = function (e) {
    ...
    console.log("-----deleteAction Codeditor -----", $selectedImage);
  ...
  CustomAddon.prototype.toolbar2Action = function (e) {
    ...
    if (callback) {
      callback(this.$el.find(ActiveClassNameSelector));
    }
