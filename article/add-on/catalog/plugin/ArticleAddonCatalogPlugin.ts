...
(function($, window, document, undefined) {
  ...
  const RootClassName = ".flip-book";
  const ActiveClassNameSelector = ".medium-insert-flip-book-active";
  const ActiveClassName = "medium-insert-flip-book-active";

  /**
   * ――――――――――――――――――――――― Default values ―――――――――――――――――――――――
   */
  const pluginName = "mediumInsert",
    addonName = "FlipBookAddon", // first char is uppercase
    defaults = {
      label: '<span class="fas fa-book-open"></span> Catalog',
