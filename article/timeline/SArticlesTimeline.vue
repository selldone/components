  ...
  <div>
    ...
    <v-timeline v-else :dense="$vuetify.breakpoint.mdAndDown">
      <v-timeline-item
        ...
        :small="_article.id !== currentArticleId"
      >
        ...
        <template v-slot:opposite>
          <s-value-dashed>
            <template v-slot:label>
              <v-icon small class="me-1">schedule</v-icon>
          ...
          <s-value-dashed>
            <template v-slot:label>
              <v-icon small class="me-1">edit_note</v-icon>
        ...
        <div class="widget-box">
          ...
          <div v-if="$vuetify.breakpoint.mdAndDown" class="mt-2">
            <s-value-dashed>
              <template v-slot:label>
                <v-icon small class="me-1">schedule</v-icon>
                {{ $t("global.article.schedule_dialog.publish_at") }}
          ...
          <p v-if="_article.parent_type === 'product'" class="m-2">
            <v-avatar left class="hover-scale" size="24">
              <v-img
    ...
    <div v-if="!busy && !timeline.length" class="text-center">
      <v-timeline :dense="$vuetify.breakpoint.mdAndDown">
        <v-timeline-item v-for="i in 3" :key="i" color="#eee">
          <template v-slot:icon>
      ...
      <h2 class="display-2 font-weight-thin px-2 py-6">
        No scheduled article!
      </h2>
    </div>
  </div>
</template>
